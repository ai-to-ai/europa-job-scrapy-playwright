...
KEYWORD_1= "Berlin"
KEYWORD_2 = "Marketing"
BASE_URL = "https://ec.europa.eu/eures/portal/jv-se/search?page=1&resultsPerPage=50&orderBy=MOST_RECENT&publicationPeriod=LAST_DAY&lang=en"
URL = f"https://ec.europa.eu/eures/portal/jv-se/search?page=1&resultsPerPage=50&orderBy=MOST_RECENT&locationCodes=de&keywordsEverywhere={KEYWORD_1}%{KEYWORD_2}&publicationPeriod=LAST_DAY&lang=en"
...
class EuSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        yield scrapy.Request(url=BASE_URL,callback=self.parse_total_page, meta=dict(
            playwright = True,
            # playwright_include_page = True,
            playwright_page_methods =[
                PageMethod('wait_for_selector', 'css=jv-se-search-page'),
                PageMethod('wait_for_timeout', 2000),
                PageMethod('click', '//*[@id="undefined-show-more-show-less"]'),
                PageMethod('evaluate', f'window.document.getElementById("occupations-search-input").value="{KEYWORD_1} {KEYWORD_2}"'),
                PageMethod('click', '//*[@id="shared-search-bar-search-btn"]'),
